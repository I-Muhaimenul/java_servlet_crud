...
<html>
    <head>
        ...
        <script>
            function validateForm() {
                var x = document.forms["frmAddUser"]["uname"].value;
                if (x == null || x == "") {
    ...
    <body>
        <form method="POST" action='UserController' name="frmAddUser" onsubmit="return validateForm()">
        ...
        <p id="ove"></p>
        <button type="button"
                onclick="document.getElementById('ove').innerHTML = Date()">
